...
// ========== Exercise 1: Add your own endpoint  ========== //
// Create a list with the names of the month
// Add an endpoint in the code /fetchMonth/:num which will fetch a particular month from a list and return it to user
// test: curl http://localhost:3333/fetchMonth/1
